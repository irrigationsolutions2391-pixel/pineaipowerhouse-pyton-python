...
from ._exceptions import APIStatusError, PineaipowerhousePytonError
...
class PineaipowerhousePyton(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous PineaipowerhousePyton client instance.
        ...
        if api_key is None:
            raise PineaipowerhousePytonError(
        ...
        if base_url is None:
            base_url = os.environ.get("PINEAIPOWERHOUSE_PYTON_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> PineaipowerhousePytonWithRawResponse:
        return PineaipowerhousePytonWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> PineaipowerhousePytonWithStreamedResponse:
        return PineaipowerhousePytonWithStreamedResponse(self)
...
class AsyncPineaipowerhousePyton(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncPineaipowerhousePyton client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncPineaipowerhousePytonWithRawResponse:
        return AsyncPineaipowerhousePytonWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncPineaipowerhousePytonWithStreamedResponse:
        return AsyncPineaipowerhousePytonWithStreamedResponse(self)
...
class PineaipowerhousePytonWithRawResponse:
    _client: PineaipowerhousePyton

    def __init__(self, client: PineaipowerhousePyton) -> None:
        self._client = client
...
class AsyncPineaipowerhousePytonWithRawResponse:
    _client: AsyncPineaipowerhousePyton

    def __init__(self, client: AsyncPineaipowerhousePyton) -> None:
        self._client = client
...
class PineaipowerhousePytonWithStreamedResponse:
    _client: PineaipowerhousePyton
...
class AsyncPineaipowerhousePytonWithStreamedResponse:
    _client: AsyncPineaipowerhousePyton
...
AsyncClient = AsyncPineaipowerhousePyton
